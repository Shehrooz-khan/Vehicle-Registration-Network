...
describe('VehicleRegistrationComponent', () => {
  ...
  let mockVehicleRegistrationService;
  let mockDataService

  beforeEach(async(() => {

    mockVehicleRegistrationService = sinon.createStubInstance(VehicleRegistrationService);
    mockVehicleRegistrationService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: VehicleRegistrationService, useValue: mockVehicleRegistrationService },
